...
# Set the start method to 'spawn' to create a clean process for the C library.
# This is critical for ensuring the ngspice C library initializes correctly
# and avoids issues with forking a multi-threaded process.
try:
    if multiprocessing.get_start_method() != 'spawn':
        multiprocessing.set_start_method('spawn', force=True)
except (RuntimeError, AttributeError):
    # This can fail if called multiple times or on some platforms.
    # We proceed, as it might have been set by another module.
    pass
