...
class Res(Cell):
    ...
    alt_symbol = Parameter(bool, optional=True, default=False) #: Use box symbol instead of zigzag symbol
...
class Vdc(Cell):
    ...
    alt_symbol = Parameter(bool, optional=True, default=False) #: Use alternative symbol
...
class PulseVoltageSource(Cell):
    ...
    Optional parameters: initial_value (defaults to 0), delay_time (defaults to 0), rise_time (defaults to 0), fall_time (defaults to 0), pulse_width (defaults to 0), period (defaults to 0).
    """
...
class PulseCurrentSource(Cell):
    ...
    Optional parameters: delay_time (defaults to 0), rise_time (defaults to 0), fall_time (defaults to 0), pulse_width (defaults to 0), period (defaults to 0).
    """
